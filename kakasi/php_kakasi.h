...
#define PHP_KAKASI_VERSION "0.1.0" /* Replace with version number for your extension */
...
/* Always refer to the globals in your function as KAKASI_G(variable).
   You are encouraged to rename these macros something shorter, see
   examples in any other php module directory.
*/
#define KAKASI_G(v) ZEND_MODULE_GLOBALS_ACCESSOR(kakasi, v)

#if defined(ZTS) && defined(COMPILE_DL_KAKASI)
